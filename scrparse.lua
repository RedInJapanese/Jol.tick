	...
	while (goscrp==1 and scrnum>=curscr and catcherror==1 and iterscr<300) or goextra==0 do
		...
		if printiter>900 or iterscr>itercatch then 
			...
			elseif cmd==0x5C then 
				...
				print(""..sf("SetVar??? (0x0027) unk=0x%02X A=%s%d B=%s%d",u8a,fa,u16a,fb,u16b)) 
			...
			elseif cmd==0x5D then 		
				...
				print(""..sf("SetVarMusicInfo?? (0x0066) X=%s%d  Z=%s%d",fa,u16a,fb,u16b))				
			...
			elseif cmd==0x8B then
				...
				print(""..sf("SetVar???? (0x008B) %s%d",fa,u16a))				
			...
			elseif cmd==0x97 then 
				...
				print(""..sf("PlayCry (0x0097) A=%s%d B=%s%d",fa,u16a,fb,u16b))				
